...
static const _Temp_type_support_symbol_names_t _Temp_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fpv_msgs, msg, Temp)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fpv_msgs, msg, Temp)),
  }
};
...
get_message_type_support_handle<fpv_msgs::msg::Temp>()
{
  return &::fpv_msgs::msg::rosidl_typesupport_cpp::Temp_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fpv_msgs, msg, Temp)() {
  return get_message_type_support_handle<fpv_msgs::msg::Temp>();
}
