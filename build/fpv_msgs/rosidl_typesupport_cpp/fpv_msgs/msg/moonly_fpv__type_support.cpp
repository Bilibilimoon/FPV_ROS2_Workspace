...
static const _MoonlyFpv_type_support_symbol_names_t _MoonlyFpv_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fpv_msgs, msg, MoonlyFpv)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fpv_msgs, msg, MoonlyFpv)),
  }
};
...
{
  return &::fpv_msgs::msg::rosidl_typesupport_cpp::MoonlyFpv_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, fpv_msgs, msg, MoonlyFpv)() {
  return get_message_type_support_handle<fpv_msgs::msg::MoonlyFpv>();
}
