...
#include "fpv_msgs/msg/detail/temp__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fpv_msgs::msg::Temp & ros_message,
...
{
  auto typed_message =
    static_cast<const fpv_msgs::msg::Temp *>(
    untyped_ros_message);
...
{
  return &fpv_msgs::msg::typesupport_fastrtps_cpp::_Temp__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fpv_msgs, msg, Temp)() {
  return &fpv_msgs::msg::typesupport_fastrtps_cpp::_Temp__handle;
}
