...
#include "fpv_msgs/msg/detail/temp_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const fpv_msgs::msg::TempMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fpv_msgs::msg::TempMsg *>(
    untyped_ros_message);
...
{
  return &fpv_msgs::msg::typesupport_fastrtps_cpp::_TempMsg__handle;
}
