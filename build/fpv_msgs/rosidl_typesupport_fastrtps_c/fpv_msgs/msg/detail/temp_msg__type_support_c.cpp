...
#include "fpv_msgs/msg/detail/temp_msg__rosidl_typesupport_fastrtps_c.h"
...
using _TempMsg__ros_msg_type = fpv_msgs__msg__TempMsg;
...
size_t get_serialized_size_fpv_msgs__msg__TempMsg(
  const void * untyped_ros_message,
...
static uint32_t _TempMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fpv_msgs__msg__TempMsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fpv_msgs
size_t max_serialized_size_fpv_msgs__msg__TempMsg(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_fpv_msgs__msg__TempMsg(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fpv_msgs, msg, TempMsg)() {
