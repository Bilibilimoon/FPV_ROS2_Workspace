...
#include "fpv_msgs/msg/detail/temp__rosidl_typesupport_fastrtps_c.h"
...
using _Temp__ros_msg_type = fpv_msgs__msg__Temp;
...
static uint32_t _Temp__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fpv_msgs__msg__Temp(
...
{
  return max_serialized_size_fpv_msgs__msg__Temp(
    full_bounded, 0);
}
