...
static const _TempMsg_type_support_symbol_names_t _TempMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fpv_msgs, msg, TempMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, fpv_msgs, msg, TempMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, fpv_msgs, msg, TempMsg)() {
  return &::fpv_msgs::msg::rosidl_typesupport_c::TempMsg_message_type_support_handle;
}
