...
// already included above
// #include "rosidl_runtime_c/action_type_support_struct.h"
#include "fpv_msgs/msg/detail/temp_msg__type_support.h"
#include "fpv_msgs/msg/detail/temp_msg__struct.h"
#include "fpv_msgs/msg/detail/temp_msg__functions.h"

static void * fpv_msgs__msg__temp_msg__create_ros_message(void)
{
  return fpv_msgs__msg__TempMsg__create();
}

static void fpv_msgs__msg__temp_msg__destroy_ros_message(void * raw_ros_message)
{
  fpv_msgs__msg__TempMsg * ros_message = (fpv_msgs__msg__TempMsg *)raw_ros_message;
  fpv_msgs__msg__TempMsg__destroy(ros_message);
}

ROSIDL_GENERATOR_C_IMPORT
bool fpv_msgs__msg__temp_msg__convert_from_py(PyObject * _pymsg, void * ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * fpv_msgs__msg__temp_msg__convert_to_py(void * raw_ros_message);


ROSIDL_GENERATOR_C_IMPORT
const rosidl_message_type_support_t *
ROSIDL_GET_MSG_TYPE_SUPPORT(fpv_msgs, msg, TempMsg);
...
_register_msg_type__msg__temp_msg(PyObject * pymodule)
{
  ...
  PyObject * pyobject_create_ros_message = NULL;
  pyobject_create_ros_message = PyCapsule_New(
    (void *)&fpv_msgs__msg__temp_msg__create_ros_message,
    NULL, NULL);
  if (!pyobject_create_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_destroy_ros_message = NULL;
  pyobject_destroy_ros_message = PyCapsule_New(
    (void *)&fpv_msgs__msg__temp_msg__destroy_ros_message,
    NULL, NULL);
  if (!pyobject_destroy_ros_message) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_from_py = NULL;
  pyobject_convert_from_py = PyCapsule_New(
    (void *)&fpv_msgs__msg__temp_msg__convert_from_py,
    NULL, NULL);
  if (!pyobject_convert_from_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_convert_to_py = NULL;
  pyobject_convert_to_py = PyCapsule_New(
    (void *)&fpv_msgs__msg__temp_msg__convert_to_py,
    NULL, NULL);
  if (!pyobject_convert_to_py) {
    // previously added objects will be removed when the module is destroyed
    return -1;
  ...
  PyObject * pyobject_type_support = NULL;
  pyobject_type_support = PyCapsule_New(
    (void *)ROSIDL_GET_MSG_TYPE_SUPPORT(fpv_msgs, msg, TempMsg),
    NULL, NULL);
  if (!pyobject_type_support) {
    // previously added objects will be removed when the module is destroyed
    return -1;
...
PyMODINIT_FUNC
PyInit_fpv_msgs_s__rosidl_typesupport_introspection_c(void)
{
