...
static const _TempMsg_type_support_symbol_names_t _TempMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, temp_msgs, msg, TempMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, temp_msgs, msg, TempMsg)),
  }
};
...
{
  return &::temp_msgs::msg::rosidl_typesupport_cpp::TempMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, temp_msgs, msg, TempMsg)() {
  return get_message_type_support_handle<temp_msgs::msg::TempMsg>();
}
