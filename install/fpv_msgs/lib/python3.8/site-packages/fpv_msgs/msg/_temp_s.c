...
bool fpv_msgs__msg__temp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fpv_msgs.msg._temp.Temp", full_classname_dest, 23) == 0);
  }
  fpv_msgs__msg__Temp * ros_message = _ros_message;
  {  // left_up_w
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * fpv_msgs__msg__temp__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Temp */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("fpv_msgs.msg._temp");
  ...
  fpv_msgs__msg__Temp * ros_message = (fpv_msgs__msg__Temp *)raw_ros_message;
  {  // left_up_w
    PyObject * field = NULL;
