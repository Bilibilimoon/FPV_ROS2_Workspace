...
bool fpv_msgs__msg__temp_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("fpv_msgs.msg._temp_msg.TempMsg", full_classname_dest, 30) == 0);
  }
  fpv_msgs__msg__TempMsg * ros_message = _ros_message;
  {  // left_up_w
...
PyObject * fpv_msgs__msg__temp_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("fpv_msgs.msg._temp_msg");
