...
#include "fpv_msgs/msg/detail/temp_msg__functions.h"
...
fpv_msgs__msg__TempMsg__create()
{
  ...
  fpv_msgs__msg__TempMsg * msg = (fpv_msgs__msg__TempMsg *)allocator.allocate(sizeof(fpv_msgs__msg__TempMsg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(fpv_msgs__msg__TempMsg));
  bool success = fpv_msgs__msg__TempMsg__init(msg);
  if (!success) {
...
fpv_msgs__msg__TempMsg__destroy(fpv_msgs__msg__TempMsg * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    fpv_msgs__msg__TempMsg__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
fpv_msgs__msg__TempMsg__Sequence__init(fpv_msgs__msg__TempMsg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fpv_msgs__msg__TempMsg * data = NULL;

  if (size) {
    data = (fpv_msgs__msg__TempMsg *)allocator.zero_allocate(size, sizeof(fpv_msgs__msg__TempMsg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = fpv_msgs__msg__TempMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        fpv_msgs__msg__TempMsg__fini(&data[i - 1]);
      }
...
fpv_msgs__msg__TempMsg__Sequence__fini(fpv_msgs__msg__TempMsg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      fpv_msgs__msg__TempMsg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  fpv_msgs__msg__TempMsg__Sequence * array = (fpv_msgs__msg__TempMsg__Sequence *)allocator.allocate(sizeof(fpv_msgs__msg__TempMsg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = fpv_msgs__msg__TempMsg__Sequence__init(array, size);
  if (!success) {
...
fpv_msgs__msg__TempMsg__Sequence__destroy(fpv_msgs__msg__TempMsg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    fpv_msgs__msg__TempMsg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
fpv_msgs__msg__TempMsg__Sequence__are_equal(const fpv_msgs__msg__TempMsg__Sequence * lhs, const fpv_msgs__msg__TempMsg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!fpv_msgs__msg__TempMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  fpv_msgs__msg__TempMsg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(fpv_msgs__msg__TempMsg);
    fpv_msgs__msg__TempMsg * data =
      (fpv_msgs__msg__TempMsg *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!fpv_msgs__msg__TempMsg__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          fpv_msgs__msg__TempMsg__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!fpv_msgs__msg__TempMsg__copy(
