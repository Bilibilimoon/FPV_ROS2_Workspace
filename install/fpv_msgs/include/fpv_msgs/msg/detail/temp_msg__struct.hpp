...
#ifndef FPV_MSGS__MSG__DETAIL__TEMP_MSG__STRUCT_HPP_
#define FPV_MSGS__MSG__DETAIL__TEMP_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__fpv_msgs__msg__TempMsg __attribute__((deprecated))
#else
# define DEPRECATED__fpv_msgs__msg__TempMsg __declspec(deprecated)
#endif
...
struct TempMsg_
{
  ...
  // pointer types
  using RawPtr =
    fpv_msgs::msg::TempMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const fpv_msgs::msg::TempMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<fpv_msgs::msg::TempMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<fpv_msgs::msg::TempMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      fpv_msgs::msg::TempMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<fpv_msgs::msg::TempMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<fpv_msgs::msg::TempMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<fpv_msgs::msg::TempMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<fpv_msgs::msg::TempMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__fpv_msgs__msg__TempMsg
    std::shared_ptr<fpv_msgs::msg::TempMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__fpv_msgs__msg__TempMsg
    std::shared_ptr<fpv_msgs::msg::TempMsg_<ContainerAllocator> const>
...
using TempMsg =
  fpv_msgs::msg::TempMsg_<std::allocator<void>>;
...
#endif  // FPV_MSGS__MSG__DETAIL__TEMP_MSG__STRUCT_HPP_
