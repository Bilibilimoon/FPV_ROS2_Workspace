...
#define NODE_MAIN_LOGGER_NAME "dgps_ros2_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdgps_ros2_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<dgps_ros2_ns::DGpsRos2>";
